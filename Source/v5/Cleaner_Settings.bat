...
ECHO M Automatic Disk Cleanup ) %adc%
...
:ConfigureDisk 
cls
echo Please Configure Your Settings For Automatic Disk Cleanup.
ping -n 3 127.0.0.1 >nul
cleanmgr /sageset:98 >NUL
set adc=Selected & set DiskCleanup=1
GOTO Menu
:noadmin
if exist "%systemdrive%\Users" (
cd \ >NUL & cd /d "%TMP%" >NUL
