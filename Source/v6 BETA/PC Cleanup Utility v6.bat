...
::Use common sense, incorrect editing of this file may result in damage or loss of data.
...
cd /d "%systemdrive%" >NUL
if exist "%systemdrive%\Users" (
if exist "%APPDATA%\Microsoft\Windows\Recent\AutomaticDestinations" mode 34,27 & GOTO JumpMenu
mode 34,26
) else (
mode 34,22
)
...
ECHO           ------------------------------------------------------------
ECHO           Thank You For Using PC Cleanup Utility v6 By Nicolas Hawrysh
ECHO           ------------------------------------------------------------
ECHO.
ECHO.
ECHO                          -----------------------------
